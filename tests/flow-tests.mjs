...
async function run() {
  ...
  try {
    ...
    assert(html.includes('myfit-version" content="23"'), 'version meta is 23');
    ...
    assert(sw.includes('my-fit-mini-v23'), 'service worker cache v23');
    ...
    pass('TEST 16: HTML/SW ship welcome + History UI + cache v23 + workout management');
  } catch (err) {
    fail('TEST 16', err);
  }
